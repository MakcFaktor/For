...
function t02() {
  let inputValue = parseInt(document.querySelector(".i-2").value);
  let str = "";
...
function t03() {
  let inputValue = parseInt(document.querySelector(".i-3").value);
  let str = "";
  for (let i = 0; i <= inputValue; i++) {
    str += i + "_";
  }
...
function t04() {
  let number = parseInt(document.querySelector(".i-4").value);
  let str = "";
...
function t05() {
  let inputValue = parseInt(document.querySelector(".i-5").value);
  let str = "";
...
function t06() {
  ...
  if (result[result.length - 2] !== number.toString() && number % 3 !== 0) {
    result += Math.ceil(number / 3) * 3 + "_";
  }
...
function t08() {
  ...
  document.querySelector(".out-8").textContent = sum;
}
...
function t09() {
  let number = parseInt(document.querySelector(".i-9").value);
  let sum = 0;
  for (let i = 0; i <= number; i++) {
    sum += i;
  }

  document.querySelector(".out-9").textContent = sum;
}
...
function t10() {
  let number = parseInt(document.querySelector(".i-10").value);
  let sum = 0;
  for (let i = 0; i <= number; i++) {
    sum += i;
    if (sum > 50) break;
...
function t11() {
  let num1 = parseInt(document.querySelector(".i-111").value);
  let num2 = parseInt(document.querySelector(".i-112").value);
  let result = "";
...
function t12() {
  let num = parseInt(document.querySelector(".i-12").value);
  let result = "";
...
const p14 = document.querySelectorAll(".p-14"); // получаем NodeList
...
const d15 = document.querySelectorAll(".d-15"); // получаем NodeList
...
function t16() {
  ...
  for (let i = 0; i < spans16.length; i++) {
    sum += parseInt(spans16[i].textContent);
  }

  document.querySelector(".out-16").textContent = `Сумма: ${sum}`;
}
...
function t19() {
  document.querySelector(".out-19").textContent = document.querySelector(
    '[name="r-19"]:checked',
  ).value;
}
...
const radio20 = document.getElementsByName("r-20");

function t20() {
  let selectedValue = "";
  for (let i = 0; i < radio20.length; i++) {
    if (radio20[i].checked) {
      selectedValue = radio20[i].value;
      break;
    }
  }
